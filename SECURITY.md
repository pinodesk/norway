...
Currently, only the latest version of Norway is actively supported with security updates.
...
When using Norway in your projects:

- Keep dependencies up to date
- Review security advisories for dependencies
- Use the latest stable version of Norway
